...
[![iOS Universal Lib](https://github.com/win880/microgrid-digital-twin/actions/workflows/ios_build.yml/badge.svg)](https://github.com/win880/microgrid-digital-twin/actions/workflows/ios_build.yml) [![iOS XCFramework](https://github.com/win880/microgrid-digital-twin/actions/workflows/xcframework_build.yml/badge.svg)](https://github.com/win880/microgrid-digital-twin/actions/workflows/xcframework_build.yml)
...
- Gebruik:
  - Push naar `master` of `main` of `Actions` → kies workflow → `Run workflow`
...
## MPC-formulering (samenvatting + ASCII)
```
Per stap t:
